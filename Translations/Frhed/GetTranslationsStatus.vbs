...
Const ForReading = 1
Const SvnWebUrlLanguages = "http://frhed.svn.sourceforge.net/viewvc/frhed/trunk/Translations/Frhed/"
...
Sub Main
  ...
  End If
  oTranslationsStatus.Add "English", GetTranslationsStatusFromPoFile("en-US.pot")
...
Class CStatus
  ...
  Public PoRevisionDate, PotCreationDate, LanguageName
  Public Translators
  Private Translator
    ...
    Do Until oTextFile.AtEndOfStream = True 'For all lines...
      ...
      If (iMsgStarted = 0) Then 'If NOT inside a translation...
        ...
        ElseIf(sMsgStr <> "") Then
          ...
          oStatus.LanguageName = GetRegExpSubMatch(sMsgStr, "X-Poedit-Language: ([A-Z ]+)")
        End If
        sMsgId = ""
        sMsgStr = ""
        bFuzzy = False
...
Sub CreateTranslationsStatusHtmlFile(ByVal sHtmlPath, ByVal oTranslationsStatus)
  ...
  oHtmlFile.WriteLine "      font-family: Verdana,sans-serif;"
  oHtmlFile.WriteLine "      font-size: small;"
  oHtmlFile.WriteLine "    }"
  oHtmlFile.WriteLine "    code,pre {"
  oHtmlFile.WriteLine "      font-family: 'Lucida Console',monospace;"
  ...
  For Each sLanguage In oTranslationsStatus.Keys 'For all languages...
    If (sLanguage <> "English") Then 'If NOT English...
      ...
      oHtmlFile.WriteLine "  <tr>"
      oHtmlFile.WriteLine "    <td class=""left"">" & oLanguageStatus.LanguageName & "</td>"
  ...
  For Each sLanguage In oTranslationsStatus.Keys 'For all languages...
    If (sLanguage <> "English") Then 'If NOT English...
      Set oLanguageStatus = oTranslationsStatus(sLanguage)
      oHtmlFile.WriteLine "  <tr>"
      oHtmlFile.WriteLine "    <td>" & oLanguageStatus.LanguageName & "</td>"
...
Sub CreateTranslationsStatusXmlFile(ByVal sXmlPath, ByVal oTranslationsStatus)
  ...
  For Each sLanguage In oTranslationsStatus.Keys 'For all languages...
    If (sLanguage <> "English") Then 'If NOT English...
      ...
      oXmlFile.WriteLine "    <language>" & oLanguageStatus.LanguageName & "</language>"
...
Sub CreateTranslatorsListFile(ByVal sHtmlPath, ByVal oTranslationsStatus)
  ...
  oHtmlFile.WriteLine "<html>"
  oHtmlFile.WriteLine "<head>"
  oHtmlFile.WriteLine "  <title>Frhed Translators</title>"
  oHtmlFile.WriteLine "  <meta http-equiv=""content-type"" content=""text/html; charset=ISO-8859-1"">"
  oHtmlFile.WriteLine "  <style type=""text/css"">"
  oHtmlFile.WriteLine "  <!--"
  oHtmlFile.WriteLine "    body {"
  ...
  oHtmlFile.WriteLine "</head>"
  oHtmlFile.WriteLine "<body>"
  oHtmlFile.WriteLine "<h1>Frhed Translators</h1>"
  oHtmlFile.WriteLine "<ul>"
  For Each sLanguage In oTranslationsStatus.Keys 'For all languages...
    If (sLanguage <> "English") Then 'If NOT English...
      Set oLanguageStatus = oTranslationsStatus(sLanguage)
      oHtmlFile.WriteLine "  <li><a href=""#" & sLanguage & """>" & oLanguageStatus.LanguageName & "</a></li>"
    End If
  Next
  oHtmlFile.WriteLine "</ul>"
  For Each sLanguage In oTranslationsStatus.Keys 'For all languages...
    If (sLanguage <> "English") Then 'If NOT English...
      ...
      Set oLanguageStatus = oTranslationsStatus(sLanguage)
      oHtmlFile.WriteLine "<h2><a name=""" & sLanguage & """>" & oLanguageStatus.LanguageName & "</a></h2>"
      oHtmlFile.WriteLine "<dl>"
      For i = 0 To oLanguageStatus.Translators.Count - 1 'For all translators...
        If (oLanguageStatus.Translators(i).Maintainer = True) Then 'If maintainer...
          If (oLanguageStatus.Translators(i).Mail <> "") Then 'If mail address exists...
    ...
    End If
  Next
  oHtmlFile.WriteLine "<p>Status from <strong>" & GetCreationDate() & "</strong>. Look at <a href=""http://frhed.sourceforge.net/translations/"">frhed.sf.net</a> for updates.</p>"
  oHtmlFile.WriteLine "</body>"
  oHtmlFile.WriteLine "</html>"
  oHtmlFile.Close
End Sub
