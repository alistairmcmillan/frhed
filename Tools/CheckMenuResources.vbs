...
' $Id: CheckMenuResources.vbs 4955 2008-01-24 21:45:40Z gerundt $
...
Sub Main
  ...
  Set oMenuItems = GetMenuItemsFromRcFile("..\FRHED\heksedit.rc")
  Set oIds = GetIdsFromRcFile("..\FRHED\heksedit.rc")
